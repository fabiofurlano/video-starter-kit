...
export function StoryboardPanel({
  ...
  const [selectedLlmModel, setSelectedLlmModel] = useState<LlmModelType>("anthropic/claude-3-haiku");
        ...
        <CollapsibleContent className="p-4">
          ...
          <div className="mb-6 p-5 border rounded-lg bg-card/50 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              {/* LLM Model Selector */}
              <div>
                <Label htmlFor="llm-model" className="text-sm font-medium mb-1.5 block">LLM Model</Label>
                <Select
              ...
              <div>
                <Label htmlFor="image-style" className="text-sm font-medium mb-1.5 block">Image Style</Label>
                <Select
            ...
            {selectedImageStyle === 'custom' && (
              <div className="mb-4">
                <Label htmlFor="custom-style" className="text-sm font-medium mb-1.5 block">Custom Style Description</Label>
                <Textarea
                  id="custom-style"
          ...
          <div className="flex gap-4 overflow-x-auto pb-6">
            {slides.map((slide, index) => (
              ...
              >
                ...
                <div>
                  <Label htmlFor={`prompt-${index}`} className="text-sm font-medium mb-1.5 block flex items-center">
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" 
                      width="14" 
                      height="14" 
                ...
                {slide.imageUrl ? (
                  ...
                  <div className="w-full h-40 bg-gradient-to-br from-gray-800/10 to-gray-800/25 rounded-md flex flex-col items-center justify-center border border-gray-700/20 shadow-inner">
                    ...
                    <span className="text-gray-500 text-sm font-medium">Image will appear here</span>
                  </div>
                )}
