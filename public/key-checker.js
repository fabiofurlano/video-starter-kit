...
(function() {
    ...
    if (!key) {
        ...
        console.log('🔑 KEY CHECKER: No falai_key found in localStorage, redirecting to key-injector.html');
        window.location.href = '/key-injector.html';
    } else {
        console.log('🔑 KEY CHECKER: falai_key found in localStorage:', key.substring(0, 5) + '...');
    }
})();
